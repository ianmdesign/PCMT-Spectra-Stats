...
async def root() -> dict[str, Any]:
    return {
        ...
        "henrikFetchMode": "after-spectra-match-completion",
    }
...
async def get_stats(
    ...
    unresolved_states = {"pending", "live", "awaiting_end", "awaiting_stats"}
    body = {
        "status": 202 if row and row.get("state") in unresolved_states else 404,
        "data": {"players": []},
    }
